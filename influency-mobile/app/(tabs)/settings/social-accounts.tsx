  ...
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      <Appbar.Header style={styles.header}>
        ...
        <Appbar.Content title="Redes Sociais" titleStyle={styles.headerTitle} />
      </Appbar.Header>

      <ScrollView style={styles.content}>
        <Text style={styles.placeholder}>Contas Conectadas - Placeholder</Text>
        <Text style={styles.subtext}>
          Lista de redes sociais conectadas (Instagram, TikTok, Facebook)
        </Text>
      </ScrollView>
